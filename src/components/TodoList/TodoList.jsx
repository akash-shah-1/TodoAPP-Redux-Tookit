  ...
  <tbody>
    { todos.length>=1 ? todos.map((item, index) => (
      <tr key={item.id} className="flex justify-between gap-x-4 py-5 bg-white m-2 my-4 border rounded-lg">
        ...
        <td className="hidden sm:flex sm:flex-col sm:items-center items-start" style={{ flex: 1 }}>
          <p className="text-sm leading-6 text-gray-900"><b>Created At</b></p>
          <p className="mt-1 text-xs leading-5 text-gray-500">
            Last seen <time dateTime="24 October">4th January</time>
          </p>
        </td>

        <td className="hidden sm:flex sm:flex-col sm:items-center items-start" style={{ flex: 1 }}>
          <p className="text-sm leading-6 text-gray-900"><b>Updated At</b></p>
          <p className="mt-1 text-xs leading-5 text-gray-500">
            Last seen <time dateTime="24 October">4th January</time>
          </p>
        </td>
        ...
        <td className="hidden sm:flex sm:flex-col sm:items-center items-start" style={{ flex: 1 }}>
          <p className="text-sm leading-6 text-gray-900"><b>Status</b></p>
          <p className="mt-1 text-xs leading-5 text-gray-500">
            Completed on <time dateTime="24 October">11th January</time>
          </p>
        </td>

        {/* New Columns */}
        <td className="flex gap-x-4 px-4 items-center" style={{ flex: 1 }}>
          <div className="flex gap-x-3">
         
            <button className="text-sm leading-6 text-gray-500 bg-green-100 hover:bg-green-200 focus:outline-none focus:underline px-2 py-1 rounded-md" onClick={()=>handleEditButtonClick(item.id, item.task)}>Edit </button>
